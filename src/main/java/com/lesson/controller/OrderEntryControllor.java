...
public class OrderEntryControllor {
	...
	public String showMenus(Model model, @RequestParam(value = "mid", required = false) String mid,
			@RequestParam(value = "cid", required = false) String cid,
			@RequestParam(value = "useCookie", required = false) String useCookie, HttpServletRequest request,
	...
	public String editMenu(Model model, @PathVariable String mid, HttpServletRequest request) {
	...
	public String saveMenu(Model model, HttpServletRequest request,
	...
	public String deleteMenu(Model model, @PathVariable int mid, HttpServletRequest request,
			HttpServletResponse response) {
	...
	public String saveCategory(Model model, @RequestParam(value = "cid", required = true) int cid,
	...
	public String deleteCategoryById(Model model, @PathVariable int cid, HttpServletRequest request) {
		try {
